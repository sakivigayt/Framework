...
public class Table extends Element {
	 ...
	 * The Logger logger
	 */
	private final static MyLogger logger = LoggerFactory.getLogger(Table.class);
	...
	public void findElement() {
		super.getElement();
		logger.info("Find the table element with tr tag");
		try {
	...
	public int getColumnCount() {
		logger.info("Get the column count");
		if (rows == null) {
			findElement();
		}
		...
		if (columns != null) {
			logger.info("Column size is ::" + columns.size());
			return columns.size();
		}
